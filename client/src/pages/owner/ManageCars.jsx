...
const ManageCars = () => {
  ...
  return (
    <div className='px-4 w-full md:px-10 pt-10'>
      <Title title="Manage Cars" subTitle="View all listed cars , update their details , or remove them from the booking platform" />

      <div className='max-w-3xl w-full w-full rounded-md overflow-hidden border border-borderColor mt-6'>
...
<td className='flex items-center p-3'>
  ...
  <img src={car.isAvaliable ? assets.delete_icon : assets.delete_icon} alt="" className='cursor-pointer'/>
</td>
